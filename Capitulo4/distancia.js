...
var line = L.polyline( [40.283155, -3.819714], { renderer: myRenderer } );
var circle = L.circle( [40.283155, -3.819714], { renderer: myRenderer } );
  ...
  var circle = L.circleMarker([40.283155, -3.819714], {radius: 50}).addTo(map);
